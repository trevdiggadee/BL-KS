...
Every file lives in one directory — no subfolders — so it's simple to
host anywhere and easy to see everything at a glance:
...
gen_icons.py           Regenerates the icon-*.png files (needs Pillow: pip install pillow)
